...
function TestStdlibConstants(stdlib) {
  "use asm";
...
assertEquals(1, WASM.asmCompileRun(TestStdlibConstants.toString()));

function TestStdlibFunctions(stdlib) {
  "use asm";
  ...
  function caller() {
    ...
    if (StdlibMathSqrt(fround(123.0)) != fround(11.090536506409418)) return 0;
    ...
    if (StdlibMathMax(fround(123.4), fround(1236.4)) != fround(1236.4)) {
      return 0;
    }
    return 1;
  }
...
assertEquals(1, WASM.asmCompileRun(TestStdlibFunctions.toString()));
