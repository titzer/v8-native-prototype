...
TEST_F(WasmMacroGenTest, Int32Ops) {
  ...
  EXPECT_SIZE(5, WASM_I32_SDIV(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_UDIV(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_SREM(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_UREM(WASM_ZERO, WASM_ZERO));
  ...
  EXPECT_SIZE(5, WASM_I32_SLT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_SLE(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_ULT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_ULE(WASM_ZERO, WASM_ZERO));

  EXPECT_SIZE(5, WASM_I32_SGT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_SGE(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_UGT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I32_UGE(WASM_ZERO, WASM_ZERO));
...
TEST_F(WasmMacroGenTest, Int64Ops) {
  ...
  EXPECT_SIZE(5, WASM_I64_SDIV(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_UDIV(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_SREM(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_UREM(WASM_ZERO, WASM_ZERO));
  ...
  EXPECT_SIZE(5, WASM_I64_SLT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_SLE(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_ULT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_ULE(WASM_ZERO, WASM_ZERO));

  EXPECT_SIZE(5, WASM_I64_SGT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_SGE(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_UGT(WASM_ZERO, WASM_ZERO));
  EXPECT_SIZE(5, WASM_I64_UGE(WASM_ZERO, WASM_ZERO));
