...
TEST_F(MacroGenTest, Statements) {
  ...
  EXPECT_SIZE(6, WASM_STORE_MEM(kAstInt32, WASM_ZERO, WASM_ZERO));
...
TEST_F(MacroGenTest, Expressions) {
  ...
  EXPECT_SIZE(4, WASM_LOAD_MEM(kAstInt32, WASM_ZERO));
  EXPECT_SIZE(4, WASM_LOAD_MEM(kAstFloat64, WASM_ZERO));
  EXPECT_SIZE(4, WASM_LOAD_MEM(kAstFloat32, WASM_ZERO));
